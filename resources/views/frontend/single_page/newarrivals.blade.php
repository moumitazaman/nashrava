@extends('frontend.layouts.master')
 @section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumbs">
                        <a href="{{url('/')}}">Home</a> <span class="separator">&gt;</span> <span>Flash Deals</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Start Breadcrumb -->
    <!-- Start Banner -->
    <div id="banner-area" style="background: rgba(0, 0, 0, 0) url({{ asset(get_static_option('newarrival_image')) }}) no-repeat center top;background-size:cover;
background-position:center;">
    ...
    <!-- End Banner -->
    <!-- Start Main Content -->
    <div id="main-content-area" class="padtop45 padbot65">
        <div class="container">
            <div class="row">
                <div class="prodcut-toolbar">
                    <form action="{{ route('newarrivalproduct.list') }}" method="get">
                    ...
                    <div class="col-sm-4 col-md-4">
                        ...
                        <ul role="tablist" class="tab-icons pull-right">
                            <li class="" role="presentation" class="active"><a data-toggle="tab" role="tab" aria-controls="grid" title="Grid" href="#grid" aria-expanded="true"><i class="fa fa-th-large"></i></a></li>
                            <li role="presentation" ><a data-toggle="tab" role="tab" aria-controls="list" title="List" href="#list" aria-expanded="false"><i class="fa fa-th-list"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            @endif
                                       ...
                                       <div class="product-hidden-info">
                                            <div class="quick-view">
                                                <a href="{{route('product.details', $cat_product->slug)}}"><i class="fa fa-eye"></i>View Detail</a>
