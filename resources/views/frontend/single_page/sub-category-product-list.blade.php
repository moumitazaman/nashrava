            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="breadcrumbs">
                        <a href="{{url('/')}}">Home</a> <span class="separator">&gt;</span> <span> SubCategory</span>
                    </div>					   
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="banner-inner"> 
                        <a class="btn-lucian" href="#">{{$cat_name->sub_category_name}}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="prodcut-toolbar"> 
                    <div class="col-sm-8 col-md-8">
                        ...
                        <form action="{{ route('sub.category.wise.product', $cat_name->id) }}" method="get">
                        <div class="col-sm-8 col-md-8">
                            <div class="toolbar-form">
            ...
            <div class="row"> 
                ...
                <div class="tab-content"> 
                    ...
                    <div id="grid" class="tab-pane" role="tabpanel"> 
                        ...
                        @foreach($sub_cat_products as $cat_product)
